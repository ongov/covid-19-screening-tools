  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        <h2>
          Based on your answers, you are part of an at-risk group. We recommend that you <strong>reduce your time outside
          your home, wear a face covering or mask, and keep a distance from others as much as possible.</strong>{" "}
        </h2>
        ...
        <div className="ontario-hide-for-print">
          ...
          <ol>
            <li>
              <AnchorLink to="/self-assessment/r4#tips">Tips to stay healthy and reduce your risk</AnchorLink>
            </li>

            <li>
              <AnchorLink to="/self-assessment/r4#covid-test">When to get a COVID-19 test </AnchorLink>
            </li>
            <li>
              <AnchorLink to="/self-assessment/r4#contact-form">Sign up for an optional follow-up call</AnchorLink>
            </li>
          </ol>
        </div>
      </div>
    ...
    <div className="ontario-row ontario-results__content" id="tips">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        <h3>
          <span className="ontario-show-for-print ontario-infographic-number">1.</span> Tips to stay healthy and reduce your risk
        </h3>
        <p className="ontario-first-line">
          Evidence shows that the virus can severely affect people who:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>if you cannot work from home, make sure you and your company are taking the right safety precautions to reduce your risk </li>
          <li>
        ...
        <ul>
          <li>wear a face covering or mask when outside</li>
    ...
    <div className="ontario-row ontario-results__content" id="covid-test">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <ul>
          ...
          <li>come into close physical contact with someone who has symptoms or has been diagnosed with COVID-19</li>
