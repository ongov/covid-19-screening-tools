  ...
  <>
    <div>
      <div className="ontario-row">
        ...
        <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content ontario-margin-bottom-0-!">
          <h2>
            ...
            <strong>go to a COVID-19 assessment centre to get tested</strong> because you have some symptoms.
          </h2>
        </div>
      </div>
      ...
      <div className="ontario-row ontario-results__content ontario-hide-for-print">
        ...
        <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
          ...
          <ol>
            ...
            <li>
              <AnchorLink to="/self-assessment/r7#sign-up-follow-up">
      ...
      <div className="ontario-row ontario-results__content" id="stay-at-home">
        ...
        <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
          <h3>
            <span className="ontario-show-for-print ontario-infographic-number">1.</span> Stay home for 14 days except to go to an assessment centre
          </h3>
          <p className="ontario-first-line">
            This is called <strong>self-isolation</strong>. The 14 days start from the date you began experiencing symptoms.
          </p>

          <p>
            You may be contagious. <strong>Do not go into public spaces unless it is for a critical reason</strong>{" "}
            (like going to an assessment centre or for a medical emergency).{" "}
          </p>
      ...
      <div className="ontario-row ontario-results__content" id="tell-people-youve-been-in-contact-with">
        ...
        <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
          <h3>
            <span className="ontario-show-for-print ontario-infographic-number">2.</span> Tell people you have been in
            close physical contact with
          </h3>
          <p className="ontario-first-line ontario-results__content--r7">
            If you were in close physical contact with someone in the 2 days before your symptoms started, you should tell them to:
          </p>
          <ul>
            <li>self-isolate</li>
          ...
          <p className="ontario-margin-top-24-!">Close physical contact means:</p>
          <ul>
      ...
      <div className="ontario-row ontario-results__content" id="monitor-your-health">
        ...
        <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
          <h3>
            <span className="ontario-show-for-print ontario-infographic-number">3.</span> Monitor your health
          </h3>
          <p className="ontario-first-line">
            Pay attention to your health and note if anything changes <strong>for 14 days</strong> after your symptoms started.
          </p>

          <p>Your doctor or the assessment centre will tell you your next steps and if you need to be re-tested.</p>

          <p><strong>Most COVID-19 illnesses are mild. If you start to experience worsening symptoms, please visit your local emergency department.
            Call before you go and let them know you have used this self-assessment.</strong></p>
