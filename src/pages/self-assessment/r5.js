  ...
  <>
    ...
    <div className="ontario-row ontario-results__content" id="stay-at-home">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <p>Stay at home so people in your community don’t get sick.</p>
    ...
    <div className="ontario-row ontario-results__content" id="monitor-your-health">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <p className="ontario-first-line">Pay attention to your health and note if anything changes.
          Visit an assessment centre for a COVID-19 test if you:</p>
        <ul>
          <li>have symptoms</li>
          <li>
